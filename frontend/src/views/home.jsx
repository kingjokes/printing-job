...
export default function Home() {
    ...
    return (
        <Box>
            <Grid2 container spacing={1} sx={{ px: 2 }} alignItems={'center'} minHeight={'80vh'}>
                ...
                <Grid2 size={{ xs: 12, sm: 6, md: 6, lg: 6 }}>
                    ...
                    <Box sx={{
                        ...
                        <Box onClick={() => inputRef.current.click()} sx={{
                            ...
                            {
                                file && <p style={{ fontWeight: '600', fontSize: 13 }}>{file?.name} -{formatSize(file?.size || 0)}</p>
                            }
            ...
            <ConfirmPayment dialog={dialog} setDialog={setDialog} setFile={setFile} quote={quote} breakdown={breakdown} />
        </Box>
    )
}